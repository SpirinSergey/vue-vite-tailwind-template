...
<template>
  <div class="xl:basis-4/12 lg:basis-5/12 md:basis-6/12 sm:basis-10/12 basis-full px-2">
    <Paragraph2>
      <input
        type="text"
  ...
  <div class="lg:basis-5/12 md:basis-6/12 sm:basis-10/12 basis-full px-2 xl:hidden">
    <Paragraph3>
      {{ $t("landing.block_7.p") }}
    </Paragraph3>
  </div>
  ...
  >
    ...
    >
      <Paragraph1
        class="group-hover:float-left w-full text-center "
      >
